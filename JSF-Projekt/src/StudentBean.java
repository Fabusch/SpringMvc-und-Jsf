...
@ManagedBean(name="studentBean") @RequestScoped
public class StudentBean implements Serializable {
    ...
    public ArrayList StudentListFromDB;
    ...
    @PostConstruct      //Wenn der Konstruktor der Klasse das Objekt nicht vollständig initalizieren kann
    //Wird PostConstruct (in Java 11 entfernt) 
    public void init() {
        StudentListFromDB = DatabaseOperation.getStudentsListFromDB();
    }
